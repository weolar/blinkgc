...
#ifndef _QUnicodeTables_Properties_
#define _QUnicodeTables_Properties_
    struct Properties {
//         ushort category : 8;
...
//         signed short caseFoldDiff : 16;
        ...
        // f:/app_prj/gui2/kdwebkit/src/corelib/tools/qunicodetables_p.h
...
inline bool isPunct(UChar32 c)
{
    ...
    return (U_MASK(QChar::category(uint32_t(c))) & test) != 0;
}
...
inline bool isSentenceStop(UChar c)
{
    return !!iswpunct(c);
}
...
inline bool isLineStop(UChar c)
{
    if (c >= '0' && c <= '9')
        return false;
