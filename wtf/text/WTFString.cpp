...
char const * WTF::numberToString(double, char * const)
{
    DebugBreak();
    return nullptr;
}

char const * WTF::numberToFixedWidthString(double, unsigned int, char * const)
{
    DebugBreak();
    return nullptr;
}

double WTF::Internal::parseDoubleFromLongString(wchar_t const *, unsigned int, unsigned int &)
{
    DebugBreak();
    return 0;
}
