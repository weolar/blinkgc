...
WebProcessMemoryDump* BlinkGCMemoryDumpProvider::currentProcessMemoryDump()
{
    DebugBreak();
    return nullptr;
}
...
BlinkGCMemoryDumpProvider::BlinkGCMemoryDumpProvider()
    : m_currentProcessMemoryDump(/*adoptPtr(Platform::current()->createProcessMemoryDump())*/nullptr)
{
}
